...
-- false = instant/max camera tracking
-- true = smooth camera tracking
...
local playerSelectCorner =
	Instance.new("UICorner")

playerSelectCorner.CornerRadius =
	UDim.new(0, 8)

playerSelectCorner.Parent =
	playerSelect
...
targetPadding.PaddingLeft =
	UDim.new(0, 9)

targetPadding.Parent =
	targetStatus
...
local function addButtonEffects(
	button,
	normalColor,
	hoverColor,
	pressColor
